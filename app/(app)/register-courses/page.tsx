...
import { availableCourses, initialCart, Course } from "@/lib/mock-data";
    ...
    <>
      ...
      >
        ...
        <div className="mb-6 flex justify-between items-end flex-wrap gap-4">
          ...
          <button
            className="md:hidden flex items-center gap-2 px-3 py-2 rounded-lg border text-sm"
            style={{
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {filtered.map((course) => {
                ...
                return (
                  <div
                    key={course.id}
                    className="rounded-xl p-4 flex flex-col card-shadow"
                    style={{
                      backgroundColor: "var(--color-surface-container-lowest)",
                      border: inCart
                  ...
                  >
                    ...
                    <button
                      disabled={isFull || (wouldExceed && !inCart)}
                      onClick={() =>
                        inCart ? removeCourse(course.id) : addCourse(course)
                      }
          ...
          <div className="xl:col-span-4 xl:sticky" style={{ top: "100px" }}>
            <div
              className="rounded-xl flex flex-col card-shadow overflow-hidden border"
              style={{
                backgroundColor: "var(--color-surface-container-lowest)",
            ...
            >
              ...
              <div className="p-6 flex-1 overflow-y-auto max-h-96">
                {cart.length === 0 ? (
                  ...
                  >
                    <span
                      className="material-symbols-outlined text-5xl opacity-30 mb-2"
                    >
                      shopping_cart
                    </span>
