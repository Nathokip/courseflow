...
import { mockStudent, registeredCourses } from "@/lib/mock-data";

export default function ProfilePage() {
  const totalCredits = registeredCourses.reduce((s, c) => s + c.credits, 0);

  const infoRows = [
    { label: "Full Name", value: mockStudent.name, icon: "person" },
    { label: "University Email", value: mockStudent.email, icon: "email" },
    { label: "Student ID", value: mockStudent.studentId, icon: "badge" },
    { label: "Current Semester", value: mockStudent.semester, icon: "calendar_month" },
  ];
    ...
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Avatar Card */}
          <div
            className="rounded-2xl p-8 flex flex-col items-center text-center card-shadow"
            style={{ backgroundColor: "var(--color-surface-container-lowest)" }}
          >
            <div className="w-24 h-24 rounded-full overflow-hidden border-4 mb-4"
            ...
            <div className="w-full mt-6">
              <div className="flex justify-between text-xs mb-1"
                ...
                <span>{totalCredits} / {mockStudent.creditLimit}</span>
              </div>
              <div
              ...
              >
                <div
                  ...
                  style={{
                    width: `${(totalCredits / mockStudent.creditLimit) * 100}%`,
          ...
          {/* Info Card */}
          <div
            className="lg:col-span-2 rounded-2xl p-8 card-shadow"
            style={{ backgroundColor: "var(--color-surface-container-lowest)" }}
          >
            <h3
